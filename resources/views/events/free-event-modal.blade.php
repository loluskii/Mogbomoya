                        ...
                        <div class="container">
                            <div class="card">
                                <div class="modal-header pl-0 flex-column py-3 mr-auto" style="border-bottom: none">
                                    ...
                                    <button type="button" class="dismiss" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span></button>
                                </div>
                                <hr style="width: auto;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="px-0 col-3">
                                                <div class="form-group">
                                                    <input type="number" id="" min="1" class="numberOfSlots custom-select form-control form-control-lg mx-3" name="guests">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
