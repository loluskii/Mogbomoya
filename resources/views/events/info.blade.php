...
<div class="container-fluid">
    <div class="row mb-5">
        <div class="col-md-6">
            <div class="card">
                <img src="{{ $event->featured_image }}" style="max-height:800px;" alt="{{$event->name}}" srcset="">
            </div>
        </div>
            ...
            <div class="container">
                <div class="card px-4 py-3 cardDetails" style="border: none">
                    ...
                    <p><span class="mr-4 text-muted">by {{ $event->user->name }} </span>
                        {{-- <button class="btn follow" disabled="disabled">Follow</button> --}}
                    </p>
                        ...
                        <div class="ml-3">
                            ...
                            {{-- <span class="mr-3">
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}"
                                    class="btn btn-sm text-white" style="background-color: #3b5998" target="_blank"><i
                                        class="fa fa-facebook text-white"></i> Share</a>
                            </span>
                            <span class="mr-3">
                                <a href="whatsapp://send?text=Mogbomoya Event {{url()->current()}}"
                                    class="btn btn-sm text-white" style="background-color: #24d366"
                                    data-action="share/whatsapp/share" target="_blank"><i
                                        class="fa fa-whatsapp text-white"></i> Share</a>
                            </span>
                            <span class="mr-3">
                                <a href="https://twitter.com/intent/tweet?text=Mogbomoya Event {{url()->current()}}"
                                    class="btn btn-sm text-white" style="background-color: #00acee" target="_blank"><i
                                        class="fa fa-twitter text-white"></i> Share</a>
                            </span> --}}
                        </div>
                        <div class="mr-3">
                    ...
                    <div class="container pl-0 mt-3 py-3">
                        <div class="pb-2">
                            <p class="mb-1" style="font-weight: bold">
                                <img class="mr-2 pr-1" src="{{ secure_asset('images/icons/calendar-black.svg') }}" srcset="">
                    ...
                    <div>
                        ...
                        <p style="font-weight: bold"><span>{{$event->registrations->count()}}</span> people are coming
                        </p>
                        @endif
                        @if($event->registrations->count() == 1)
                        <p style="font-weight: bold"><span>{{$event->registrations->count()}}</span> person is coming
                        </p>
                        @endif
