                        ...
                        @foreach ($interests as $interest)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info btn-sm" href="#" data-toggle="modal" data-target="#updateInterestModal{{$interest->id}}">Edit</a>
                                    @if ($interest->trashed())
                                        <a onclick="return confirm('Are you sure you want to delete this interest?')" class="btn btn-success btn-sm" href="{{route('admin.interest.restore', $interest->id)}}">Restore</a>
                                    @else
                                        <a onclick="return confirm('Are you sure you want to delete this interest?')" class="btn btn-danger btn-sm" href="{{route('admin.interest.delete', $interest->id)}}">Delete</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
