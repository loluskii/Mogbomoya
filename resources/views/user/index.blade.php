        ...
        <div class="container px-4 mt-4 mt-sm-2 pt-3">
            ...
            <div class="col-md-4 col-sm-10 px-sm-5 px-0">
                <div class="form-group">
                    ...
                    <button type="button" style="padding: 8px 16px" name="changeEmail" id="changeEmail"
                        class="w-100 rounded form-contro-lg text-center bg-white border text-muted">Change
                        Email</button>
                </div>
            </div>
            <div class="col-md-4 col-sm-10  px-sm-5 px-0">
                <div class="form-group">
                    ...
                    <button type="button" style="padding: 8px 16px" name="changePassword" id="changePassword"
                        class="w-100 rounded form-contro-lg text-center bg-white border text-muted">Change
                        Password</button>
                </div>
            </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="" class="form-control form-control-lg"
                                value="{{ auth()->user()->name }} " placeholder="John Appleased"
                ...
                <div class="form-row py-2 px-sm-5">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" id="" value="{{ auth()->user()->username }}"
                                class="form-control form-control-lg" placeholder="appleased" aria-describedby="helpId">
                            @error('username')
                            <b class="text-danger">{{ $message }} </b>
                            @enderror
                        </div>
                    ...
                    {{-- <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="display_name" id="" class="form-control form-control-lg"
                                placeholder="John Appleseed" aria-describedby="helpId">
                        </div>
                    </div> --}}
                </div>
                <div class="form-row py-2 px-sm-5">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone_number" id="" class="form-control form-control-lg"
                                value="{{ auth()->user()->phone_number ?? '' }}" placeholder="+234 123 4567 890"
                                aria-describedby="helpId">
                            @error('phone_number')
                            <b class="text-danger">{{ $message }} </b>
                            @enderror
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-lg interests" name="interests[]" id="" multiple>
                                ...
                                <option value="{{ encrypt($interest->id) }}" data-icon="{{ secure_asset("
                                    images/icons/$interest->icon") }}" {{ in_array($interest->id, $myInterests) ?
                                    'selected' : '' }}>
                                    {{ $interest->name }}
                                </option>
                                @endforeach
