...
<div class="container-fluid">
    <div class="row mb-5">
        <div class="col-md-6">
            <div class="card">
                <img src="{{ $event->featured_image }}" style="max-height:800px;" alt="" srcset="">
            </div>
        </div>
                ...
                <div class="card px-4 py-3 cardDetails" style="border: none">
                    ...
                    <div class="row justify-content-between mb-4">
                        <div class="ml-3">
                            {{-- <a href="http://" class="btn save shadow border-0" role="button" data-toggle="dropdown"
                                ...
                                <img src="{{ secure_asset('images/icons/analytics.svg') }}" srcset="">
                            </a> --}}
                            ...
                            <a href="http://" class="border-0 btn save shadow">
                                <img src="{{ secure_asset('images/icons/edit.svg') }}" srcset="">
                            </a>
                    ...
                    <div class="container pl-0 mt-4 py-3">
                        <div class="pb-2">
                            <p class="mb-1" style="font-weight: bold"><img class="mr-2"
                                    src="{{ secure_asset('images/icons/calendar-black.svg') }}" srcset=""> {{
                                \Carbon\Carbon::parse($event->date)->toFormattedDateString()}}
                            </p>
                            <p class="ml-4 pl-3">{{ \Carbon\Carbon::parse($event->time)->toTimeString()}} WAT</p>
                            <p style="font-weight: bold; cursor: pointer;" class="ml-4 pl-3"><span
                                    style="color: #008A69;" data-toggle="modal" data-target="#updateTimeModal">Change
                        ...
                        <div class="py-1">
                            ...
                            <p style="font-weight: bold;  cursor: pointer;" class="ml-4 pl-3"><span
                                    style="color: #008A69;" data-toggle="modal"
                                    data-target="#updateLocationModal">Change Location</span></p>
                        </div>
                        @elseif ($event->link)
                        <div class="py-1">
                            ...
                            <p style="font-weight: bold;  cursor: pointer;" class="ml-4 pl-3"><span
                                    style="color: #008A69;" data-toggle="modal"
                                    data-target="#updateLocationModal">Change Link</span></p>
                        </div>
                        @endif
                        <div class="py-1">
                            <p class="mb-1" style="font-weight: bold"><img class="mr-3"
                                    src="{{ secure_asset('images/icons/ticket-black.svg') }}" srcset="">{{$event->isPaid == 0 ?
                    ...
                    <div class="mt-3">
                        ...
                        <div class="row justify-content-between">
                            ...
                            @endif
                            @if($event->registrations->count() < 1) <p class="ml-3"> No one has registered for this
                                event</p>
                                @endif
                                {{-- <div class="ml-3">
                                ...
                                <div class="mr-3">
                                    <button class="ml-auto btn follow" data-toggle="modal"
                                        data-target="#sendNoteModal">Send a note to all registrants</button>
                                </div>
                        </div>
                        <p></p>
                        <div class="pt-4 pb-2 row">
                            <h5 class="font-weight-bold">About this event</h5>
                            <button class="ml-auto mr-3 btn follow" data-toggle="modal"
                                data-target="#editDescriptionModal">Edit</button>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header flex-column" style="border-bottom: none">
                ...
                <p class="mb-0"> By changing the details of this event, a notification will be sent to registered
                    attendees, with the updated information.</p>
            </div>
            <hr>
            <div class="modal-body">
                <form action="{{route('update.event-info', $event->reference)}}" method="POST">
                    ...
                    <div class="form-row pb-4">
                        <div class="col-md-6 col-6">
                            ...
                            <input type="date" class="form-control form-control-lg" value="{{$event->date}}"
                                name="date">
                        </div>
                        <div class="col-md-6 col-6">
                            <label for="">TIME</label>
                            <input type="time" class="form-control form-control-lg" value="{{$event->time}}"
                                name="time">
                        </div>
                    </div>
                    <div class="py-4">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header flex-column" style="border-bottom: none">
                ...
                <p class="mb-0"> By changing the location, everyone that has registeredfor your event would get a
                    notification.</p>
            </div>
            <hr>
            <div class="modal-body">
                <form action="{{route('update.event-info', $event->reference)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" id="" class="form-control form-control-lg" placeholder=""
