...
<div class="col-md-3 d-none d-md-block d-sm-none sidebar" style="height: 120vh">
    <div class="list-group list-group-flush mt-5 pt-2 justify-content-center">
        <a href="/" class="mb-5 pb-5"><img src="{{asset('images/Mogbomoya _White).png')}}" class="img-fluid text-center"
        ...
        <a class="list-group-item list-group-item-action p-3" data-toggle="modal" id="inputPassword"
            data-target="#deactivateModal">Deactivate account</a>
        @else
