    ...
    <div class="row py-3">
        ...
        <div class="col-md-3">
            <div class="card shadow">
                ...
                <img src="{{secure_asset("
                    images/event/".$collection->event_collections->first()->event->featured_image)}}"
                class="card-img-top" alt="{{$collection->name}}">
                @else
                <img src="https://www.online-tech-tips.com/wp-content/uploads/2020/04/WallpaperCraft.jpg.optimal.jpg"
                    class="card-img-top" alt="{{$collection->name}}">
                @endif
                <div class="card-body">
                    <a href="{{route('collection.info', $collection->reference)}}">
                        <h5 class="text-dark  card-title">{{ $collection->name }}</h5>
                    </a>
                </div>
            </div>
        </div>
            ...
            <form action="{{route('collection.store')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="" class="form-control form-control-lg" placeholder=""
