                        ...
                        <div class="bg-white border" style="overflow:scroll; height: 30vh;">
                            ...
                            <div class="container" style="overflow:scroll; height: 40vh">
                                ...
                                <div class="form-inline border rounded p-sm-2 mb-2"> <input type="radio"
                                        value="{{$interest->id}}" name="category" {{request()->category == $interest->id
                                    ? 'checked' : ''}}> <label for="" class="pl-1 pt-sm-0 pt-1">
