...
<body>
    ...
    <nav class="slide-content p-3">
        <div class="list-group list-group-flush mt-5 pt-2 justify-content-center">
            <a href="/" class="pb-3"><img src="{{ asset('images/Mogbomoya _White).png')}}" class="img-fluid text-center"
                    style="height: 150px" srcset=""></a>
            ...
            <a class="list-group-item list-group-item-action p-3" href="{{route('bank.details')}}">Bank account
                details</a>
            ...
            <a class="list-group-item list-group-item-action p-3"
                onclick="return confirm('Are you sure you want to deactivate this account?') ? initRoute() : '' "
                href="#">Deactivate account</a>
            @endif
    ...
    <nav class="slide-content p-3">
        <div class="list-group list-group-flush mt-5 pt-2 justify-content-center">
            ...
            <a class="list-group-item list-group-item-action bg-transparent text-white"
                href="{{ route('event.create') }}">Create Event</a>
            <a class="list-group-item list-group-item-action p-3" href="{{ route('events.near') }}">Find Events Near
                Me</a>
            <a class="list-group-item list-group-item-action bg-transparent text-white"
